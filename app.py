...
def daily_scheduler():
    ...
    print("🕐 بدأ جدول التذكيرات اليومية")
    last_morning_hour = -1
    last_evening_hour = -1
    last_sleep_hour = -1
...
🔹 *سبحان الله*
إضافة +1 لعداد سبحان الله (33 مرة)

🔹 *الحمد لله*
إضافة +1 لعداد الحمد لله (33 مرة)

🔹 *الله أكبر*
إضافة +1 لعداد الله أكبر (33 مرة)

🔹 *استغفر الله*
إضافة +1 لعداد استغفر الله (33 مرة)
